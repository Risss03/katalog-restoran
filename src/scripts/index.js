...
function displayJSONData(data) {
    ...
    data.restaurants.forEach(restaurant => {
      ...
      restaurantDiv.innerHTML = `
        ...
        <p>Rating: ${restaurant.rating}</p>
              `;
      restaurantListElement.appendChild(restaurantDiv);
    });
  }
  ...
  // Call the function with the JSON data to display it on the web page
...
const hamburgerButtonElement = document.querySelector('#hamburger-menu');
